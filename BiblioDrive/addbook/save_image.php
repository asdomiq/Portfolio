...
if(isset($_POST["btnAddBook"])) {
    ...
    if ($uploadOk == 1) {
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
                ...
                $stmt->execute();
                header("Location: http://".$_SERVER["HTTP_HOST"]."/Portfolio/BiblioDrive/bookinfo/?infobook=".$connexion->lastInsertId());
    ...
    header("Location: http://".$_SERVER["HTTP_HOST"]."/Portfolio/BiblioDrive");
 }
?>