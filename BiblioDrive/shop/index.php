...
require_once('../res/body_start.php');
  ...
  <div class="row">
   <div class="col-md-9">
    <a href="http://'.$_SERVER["HTTP_HOST"].'/Portfolio/BiblioDrive/bookinfo/?infobook='.$enregistrement->nolivre.'" class="text-center text-dark">
   ...
   <div class="col-md-3">
    <div class="card bg-secondary">
     <div class="card-body">
      <form action="http://'.$_SERVER["HTTP_HOST"].'/Portfolio/BiblioDrive/bookinfo/?infobook='.$enregistrement->nolivre.'" class="form-row" method="post">                         
