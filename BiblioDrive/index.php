...
<body class="bg-dark">
 ...
 echo'  <div class="row">
   <div class="col-md-9">
      ...
      <div class="col-md-12">
       <div class="card bg-secondary">
        <div class="card-body">
         <div class="row">
          <div class="col-md-3">
           <a href="http://'.$_SERVER["HTTP_HOST"].'/Portfolio/BiblioDrive/addbook" class="text-dark">Ajouter un livre</a>
          </div>
          <div class="col-md-3">
           <a href="http://'.$_SERVER["HTTP_HOST"].'/Portfolio/BiblioDrive/adduser" class="text-dark">Ajouter un utilisateur</a>
          </div>
         </div>
        </div>
       </div>
    ...
    <div class="col-md-3">
     <a href="http://'.$_SERVER["HTTP_HOST"].'/Portfolio/BiblioDrive">
      <div class="card bg-secondary">
       <div class="card-body">
   ...
   <div class="col-md-9">
    <div class="card bg-secondary">
     ...
     <div class="row">
      ...
      <div class="col-md-3">
       <a href="http://'.$_SERVER["HTTP_HOST"].'/Portfolio/BiblioDrive/shop" class="text-dark">
        <div class="card bg-secondary">
         <div class="card-body">
...
while($enregistrement = $stmt->fetch()){
	echo'
	<a href="http://'.$_SERVER["HTTP_HOST"].'/Portfolio/BiblioDrive/bookinfo/?infobook='.$enregistrement->nolivre.'">
	  <div class="item">
